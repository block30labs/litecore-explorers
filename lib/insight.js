...
function Insight(url, network) {
  ...
  if (Networks.get(url)) {
    ...
    if (network === Networks.livenet) {
      url = 'https://litecoin.block30enterprise.com';
    } else {
      url = 'https://litecoin.block30enterprise.com';
    }
  }
...
Insight.prototype.getTransaction = function(txid, callback) {
  ...
  this.requestGet('/insight-lite-api/tx/' + txid, function(err, res, body) {
...
Insight.prototype.getUtxos = function(params, callback) {
    ...
    this.requestPost('/insight-lite-api/addrs/utxo', {
...
Insight.prototype.broadcast = function(transaction, callback) {
  ...
  this.requestPost('/insight-lite-api/tx/send', {
    rawtx: transaction
...
Insight.prototype.address = function(params, callback) {
  ...
  this.requestGet('/insight-lite-api/addr/' + address.toString() + queryString, function(err, res, body) {
    if (err || res.statusCode !== 200) {
      return callback(err || body);
    }
    var info;
...
Insight.prototype.getBlocks = function(callback) {
    ...
    this.requestGet('/insight-lite-api/blocks/', function(err, res, body) {
        if (err || res.statusCode !== 200) {
            return callback(err || res);
        }
...
Insight.prototype.getBlock = function(blockhash, callback) {
    ...
    this.requestGet('/insight-lite-api/block/' + blockhash, function(err, res, body) {
        if (err || res.statusCode !== 200) {
            return callback(err || res);
        }
